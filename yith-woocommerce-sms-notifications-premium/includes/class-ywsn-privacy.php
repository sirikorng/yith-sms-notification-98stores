...
if ( ! class_exists( 'YITH_WSN_Privacy' ) ) {
	/**
	 * Class YITH_WSN_Privacy
	 * Privacy Class
	 *
	 * @author Alberto Ruggiero
	 */
	class YITH_WSN_Privacy extends YITH_Privacy_Plugin_Abstract {

		/**
		 * YITH_WSN_Privacy constructor.
		 */
		...
		public function get_privacy_message( $section ) {
			...
			switch ( $section ) {
				case 'collect_and_store':
                    ...
                    <p class="privacy-policy-tutorial"><?php _ex( 'If they accept, they will be sent an SMS text every time the order status is changed (if set by the admin).', 'Privacy Policy Content', 'yith-woocommerce-sms-notifications' ) ?></p>
